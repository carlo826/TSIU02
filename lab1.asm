...
readSignal:
	...
	sbi PORTD, 0	; Om A0 är satt sätt B0

	call DELAY		; Vänta t för nästa bit
	sbic PINA, 0	; Kolla om A0 är satt
	sbi PORTD, 1	; Om A0 är satt sätt B1

	call DELAY		; Vänta t för nästa bit
	sbic PINA, 0	; Kolla om A0 är satt
	sbi PORTD, 2	; Om A0 är satt sätt B2

	call DELAY		; Vänta t för nästa bit	
	sbic PINA, 0	; Kolla om A0 är satt
	sbi PORTD, 3	; Om A0 är satt sätt B3
...
HALFDELAY:
	...
	ldi r17,8 ; Första värde som bestämmer antal loops
